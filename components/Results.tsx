  ...
  return (
    <section className="border-2 border-black rounded-[22px] overflow-hidden">
      <div className="flex flex-col">
        {[...Array(6)].map((_, i) => (
          <div key={i} className="flex flex-col md:flex-row border-b-2 border-black last:border-b-0 bg-white md:min-h-[185px]">
            {/* First Column - Thumbnail */}
            <div className="w-full md:w-[320px] h-[185px] flex-shrink-0 bg-gray-200">
